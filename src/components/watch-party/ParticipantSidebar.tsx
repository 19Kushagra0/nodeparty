  ...
  return (
    <div className="w-full h-full min-h-0 bg-white/70 backdrop-blur-md border border-white rounded-[20px] sm:rounded-[24px] p-3 sm:p-4 flex flex-col shadow-xs overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-3 px-0.5 shrink-0 gap-2">
        <div className="flex-1 min-w-0 flex gap-1 bg-zinc-100/70 p-1 rounded-full border border-zinc-200/50">
          <button
        ...
        <button
          ...
          className="w-8 h-8 rounded-full bg-zinc-100/80 hover:bg-zinc-200/80 text-zinc-500 hover:text-zinc-800 flex items-center justify-center transition-all cursor-pointer outline-none focus:outline-none border border-zinc-200/50 shadow-2xs active:scale-95 shrink-0"
          title="Minimize sidebar to right"
          aria-label="Minimize sidebar to right"
        >
          <ChevronRight className="w-4 h-4 text-zinc-600 stroke-[2.2]" />
        </button>
      </div>
        ...
        <>
          ...
          <form onSubmit={handleSendMessage} className="relative mt-1 shrink-0">
            ...
            <button
              ...
              className="absolute right-1.5 top-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-pink-500 hover:bg-pink-600 disabled:bg-zinc-300 disabled:opacity-40 text-white flex items-center justify-center transition-all cursor-pointer shadow-2xs disabled:cursor-not-allowed active:scale-95"
            >
            ...
            <div className="flex items-center gap-1.5">
              <div className="flex bg-zinc-100/80 p-0.5 rounded-lg border border-zinc-200/50">
                <button
                  ...
                  className={`p-1 rounded-md text-xs transition-all cursor-pointer outline-none focus:outline-none focus-visible:outline-none select-none border ${
                    usersViewMode === "grid"
                      ? "bg-white text-zinc-900 shadow-2xs font-bold border-zinc-200/60"
